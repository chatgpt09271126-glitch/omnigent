      ...
      <QueryClientProvider client={qc}>
        <TooltipProvider>
          <ChatHeader
            ...
            canManageThreadSettings={props.canManageThreadSettings ?? false}
...
describe("ChatHeader — thread settings", () => {
  it("shows the per-thread settings control for an active conversation", () => {
    renderHeader({
      sidebarOpen: true,
