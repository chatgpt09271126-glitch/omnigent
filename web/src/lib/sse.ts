...
// The server heartbeats the session live-tail every 2 s of queue idleness
...
// freezes. Four missed heartbeats trip the guard; one late heartbeat doesn't.
export const SSE_STALL_TIMEOUT_MS = 8_000;
